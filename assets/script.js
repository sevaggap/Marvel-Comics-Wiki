...
function handleSearchFormSubmit (event) {
    ...
    if (!character) {
        ...
        buttonEl.setAttribute("data-target", "0");
        inputEl.setAttribute("style", "background-color: white");
    ...
    .then (function (data) {
        console.log(data);
        console.log("checking if character in database");
    if (!data.data.results[0]) {
        console.log("nothing");
        inputEl.setAttribute("style", "background-color:rgb(233, 40, 40)");
    } else {
